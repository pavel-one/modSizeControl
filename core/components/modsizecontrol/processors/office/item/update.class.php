...
class modSizeControlOfficeItemUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('modsizecontrol_item_err_ns');
        }
...
return 'modSizeControlOfficeItemUpdateProcessor';
