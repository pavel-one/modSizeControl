...
switch($modx->event->name) {
    case 'OnManagerPageInit':
        ...
        ");
        $modx->regClientCSS($modSizeControl->config['cssUrl'] . 'mgr/default.css?ver=1.0.8');
        $modx->regClientStartupScript($modSizeControl->config['jsUrl'] . 'mgr/default.js?ver=1.0.8');
        break;
