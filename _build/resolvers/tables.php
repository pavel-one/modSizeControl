...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modx->addPackage('modsizecontrol', MODX_CORE_PATH . 'components/modsizecontrol/model/');
            $manager = $modx->getManager();
            $objects = [];
            $schemaFile = MODX_CORE_PATH . 'components/modsizecontrol/model/schema/modsizecontrol.mysql.schema.xml';
